    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='cursos.local')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='curso_de_interesse', to='cursos.curso')),
            ],
        ),
        migrations.CreateModel(
            name='Presenca',
