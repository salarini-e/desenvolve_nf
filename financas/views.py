...
def formularios(request):
    arquivos = {'alvara': [['Requerimento Alvará', 'alvara/REQUERIMENTO-DE-ALVARA.pdf'],
                ...
                'iptu': [['requerimento_baixaDeb', 'REQUERIMENTO-DE-BAIXA-DE-DEBITO.pdf'],
                         ['requerimento_inclusao',
                          'REQUERIMENTO-DE-INCLUSAO-DE-POSSUIDOR.pdf'],
                         ['requerimento_recolhimento',
                          'REQUERIMENTO-DE-RECOLHIMENTO-DE-TRIBUTOS-1.pdf'],
                         ['requerimento_revisao', 'REQUERIMENTO-REVISAO-DE-IPTU-1.pdf']],
                'itbi': [['declaracao_ciencia_itbi', 'DECLARACAO-DE-CIENCIA-DE-ITBI.pdf'],
                         ['declaracao_transacao_imobiliaria',
                          'Declaracao-de-Transacao-Imo-biliaria-ITBI-PMNF-5.pdf'],
                         ['requerimento_revisao_itbi', 'REQUERIMENTO-DE-REVISAO-DE-ITBI.pdf']],
                'isencao': [['requerimento_imunidade_tributaria', 'REQUERIMENTO-DE-IMUNIDADE-TRIBUTARIA-form.pdf'],
                            ['requerimento_isencao',
                             'REQUERIMENTO-DE-ISENCAO-MEI-TFA-1.pdf'],
                            ['requerimento_insencao_nao_incidencia_tributaria', 'REQUERIMENTO-DE-ISENCAO-NAO-INCIDENCIA-TRIBUTARIA.pdf'], ['requerimento_isencao_parcial_tombamento', 'REQUERIMENTO-DE-ISENCAO-PARCIAL-TOMBAMENTO.pdf']],
                'diversos': [['requerimento_imunidade_tributaria', 'REQUERIMENTO-DE-IMUNIDADE-TRIBUTARIA-form.pdf'],
                             ['requerimento_isencao',
                              'REQUERIMENTO-DE-ISENCAO-MEI-TFA-1.pdf'],
                             ['requerimento_insencao_nao_incidencia_tributaria',
                              'REQUERIMENTO-DE-ISENCAO-NAO-INCIDENCIA-TRIBUTARIA.pdf'],
