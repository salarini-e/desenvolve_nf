    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsavel_tributario', models.CharField(blank=True, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requerente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='financas_recadastramento.pessoarecadastramento')),
            ],
        ),
        migrations.CreateModel(
            name='Inscricao',
